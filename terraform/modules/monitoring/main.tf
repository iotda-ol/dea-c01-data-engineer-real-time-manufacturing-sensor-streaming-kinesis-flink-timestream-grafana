    ...
    widgets = [
      {
        ...
        properties = {
          metrics = [
            ["AWS/Kinesis", "IncomingRecords", "StreamName", var.kinesis_stream_name, { stat = "Sum", label = "Incoming Records" }],
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/KinesisAnalytics", "uptime", "Application", var.flink_app_name, { stat = "Average", label = "Uptime" }],
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/Kinesis", "GetRecords.IteratorAgeMilliseconds", "StreamName", var.kinesis_stream_name, { stat = "Maximum", label = "Iterator Age" }]
          ]
          period = 300
          stat   = "Maximum"
          region = data.aws_region.current.name
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/KinesisAnalytics", "numFailedCheckpoints", "Application", var.flink_app_name, { stat = "Sum", label = "Failed Checkpoints" }],
